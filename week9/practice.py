...
# # ______________________________________________________________________slide 17
# # right now I will be going over using a parameter
# def printRecipe(food):
#     if (food == "taco"):
#         print("1. Cook tortilla")
#         print("2. Place cooked chicken onto tortilla.")
...
# print(printRecipe("taco"))
# # ______________________________________________________________________slide 18
# def printRecipe(meal, desert):
#     if (meal == "taco"):
#         print("1. Cook tortilla")
#         print("2. Place cooked chicken onto tortilla.")
